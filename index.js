...
const questions = [
    {
        type: 'input',
        name: 'name',
        message: 'Welcome to the Somraj README generator! To begin, please provide your full name:',
        validate: nameInput => {
            if (nameInput) {
                return true;
            } else {
...
const writeToFile = data => {
    return new Promise((resolve, reject) => {
        ...
        fs.writeFile('./utils/README.md', data, err => {
            ...
            resolve({
                ok: true,
                message: console.log('Readme file created successfully ! Navigate to the main folder to see the generated README! based on the questions asnwered')
            });
        })
    })
}
